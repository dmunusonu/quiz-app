...
for(i=0;i<option.length;i++){
 ...
 let tickIconTag = '<div class ="icon tick"><i class="fa-light fa-circle-check"></i></div>';
 let crossIconTag = '<div class ="icon cross"><i class="fa-sharp fa-light fa-circle-xmark"></i></div>';
